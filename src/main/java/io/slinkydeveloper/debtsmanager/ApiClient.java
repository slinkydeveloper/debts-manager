...
public class ApiClient {
    ...
    private String loggedUserToken_token;
    ...
    /**
     * Call getTransactions with empty body. 
     * 
    ...
    public void getTransactions(
        ...
        this.attachLoggedUserTokenSecurity(request, requestCookies);
    ...
    /**
     * Call createTransaction with empty body. 
     * 
     * @param handler The handler for the asynchronous request
     */
    public void createTransactionWithEmptyBody(
        Handler<AsyncResult<HttpResponse>> handler) {
        // Check required params
    ...
    /**
     * Call createTransaction with Json body. 
     * 
     * @param body  that represents the body of the request
     * @param handler The handler for the asynchronous request
     */
    public void createTransactionWithJson(
        NewTransaction body, Handler<AsyncResult<HttpResponse>> handler) {
        // Check required params
    ...
    /**
     * Call getTransaction with empty body. 
     * 
     * @param transactionId Parameter transactionId inside path
     * @param handler The handler for the asynchronous request
     */
    public void getTransaction(
        ...
        Handler<AsyncResult<HttpResponse>> handler) {
        // Check required params
        if (transactionId == null) throw new NullPointerException("Missing parameter transactionId in path");
        

        // Generate the uri
        String uri = "/transactions/{transactionId}";
        uri = uri.replaceAll("\\{{1}([.;?*+]*([^\\{\\}.;?*+]+)[^\\}]*)\\}{1}", "{$2}"); //Remove * . ; ? from url template
        uri = uri.replace("{transactionId}", this.renderPathParam("transactionId", transactionId));
    ...
    /**
     * Call updateTransaction with empty body. 
     * 
     * @param transactionId Parameter transactionId inside path
     * @param handler The handler for the asynchronous request
     */
    public void updateTransactionWithEmptyBody(
        String transactionId,
        Handler<AsyncResult<HttpResponse>> handler) {
        // Check required params
        if (transactionId == null) throw new NullPointerException("Missing parameter transactionId in path");
    ...
    /**
     * Call updateTransaction with Json body. 
     * 
     * @param transactionId Parameter transactionId inside path
     * @param body  that represents the body of the request
     * @param handler The handler for the asynchronous request
     */
    public void updateTransactionWithJson(
        String transactionId,
        UpdateTransaction body, Handler<AsyncResult<HttpResponse>> handler) {
        // Check required params
        if (transactionId == null) throw new NullPointerException("Missing parameter transactionId in path");
    ...
    /**
     * Call deleteTransaction with empty body. 
     * 
     * @param transactionId Parameter transactionId inside path
     * @param handler The handler for the asynchronous request
     */
    ...
    /**
     * Call getUserStatus with empty body. 
     * @param handler The handler for the asynchronous request
     */
    ...
    /**
     * Call login with Json body. 
     * @param body  that represents the body of the request
     * @param handler The handler for the asynchronous request
     */
    public void loginWithJson(
      AuthCredentials body, Handler<AsyncResult<HttpResponse>> handler) {
        // Check required params
    ...
    /**
     * Call register with Json body. 
     * @param body  that represents the body of the request
     * @param handler The handler for the asynchronous request
     */
    public void registerWithJson(
        AuthCredentials body, Handler<AsyncResult<HttpResponse>> handler) {
        // Check required params
    ...
    /**
     * Call getConnectedUsers with empty body. 
     * @param handler The handler for the asynchronous request
     */
    ...
    /**
     * Call connectUser with empty body. 
     * 
     * @param handler The handler for the asynchronous request
     */
    public void connectUserWithEmptyBody(
        Handler<AsyncResult<HttpResponse>> handler) {
        // Check required params
        

        // Generate the uri
        String uri = "/connectUser";
    ...
    /**
     * Call connectUser with Json body. 
     * 
     * @param body  that represents the body of the request
     * @param handler The handler for the asynchronous request
     */
    public void connectUserWithJson(
        String body, Handler<AsyncResult<HttpResponse>> handler) {
        // Check required params
    ...
    private void attachLoggedUserTokenSecurity (HttpRequest request, MultiMap cookies) {
        this.addHeaderParam("Authorization", "Bearer " + loggedUserToken_token, request);
    ...
    /**
     * Set access token for security scheme loggedUserToken
     */
    public void setLoggedUserTokenToken(String token) {
        this.loggedUserToken_token = token;
    }
